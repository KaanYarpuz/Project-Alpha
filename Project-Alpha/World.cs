...
public static class World
{
    ...
    public const int WEAPON_ID_OLD_SPEAR = 3;
    public const int WEAPON_ID_CHIPPED_AXE = 4;
    public const int WEAPON_ID_STEEL_BLADE = 5;
    public const int WEAPON_ID_ROYAL_POLEAXE = 6;
    public const int WEAPON_ID_RAT_SMASHER = 7;
    public const int WEAPON_ID_RADIENT_HEROIC_SWORD = 8;
    public const int WEAPON_ID_RESTRAINING_ORDER = 9;
    public const int WEAPON_ID_DESERT_EAGLE = 10;
    ...
    public static void PopulateWeapons()
    {
        ...
        Weapons.Add(new Weapon(WEAPON_ID_SPIKED_CLUB, "Spiked Club", 10));
        Weapons.Add(new Weapon(WEAPON_ID_OLD_SPEAR, "Old Spear", 12));
        Weapons.Add(new Weapon(WEAPON_ID_CHIPPED_AXE, "Chipped Axe", 11));
        Weapons.Add(new Weapon(WEAPON_ID_STEEL_BLADE, "Steel Blade", 16));
        Weapons.Add(new Weapon(WEAPON_ID_ROYAL_POLEAXE, "Royal Poleaxe", 19));
        Weapons.Add(new Weapon(WEAPON_ID_RAT_SMASHER, "Rat Smasher", 9));
        Weapons.Add(new Weapon(WEAPON_ID_RADIENT_HEROIC_SWORD, "Radient Heroic Sword", 25));
        Weapons.Add(new Weapon(WEAPON_ID_RESTRAINING_ORDER, "Restraining Order", 9999));
        Weapons.Add(new Weapon(WEAPON_ID_DESERT_EAGLE, "Desert Eagle", 830));
    }
